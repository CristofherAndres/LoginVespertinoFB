...
import com.example.loginvespertinofb.databinding.ActivityChangePassBinding
...
class ChangePassActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Validar los datos cuando presione el boton
        ...
        binding.btnChangePass.setOnClickListener {
            ...
            //Validar que las controseñas sean iguales
